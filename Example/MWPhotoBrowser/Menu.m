...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch (indexPath.row) {
		...
		case 5:
            // Photos
            [photos addObject:[MWPhoto photoWithURL:[NSURL URLWithString:@"https://lh3.googleusercontent.com/xFShQbZDDHmGKRs0GAZFiTobN4NHTFDyOfbu1-OvRBkMoIptOprQ56TXdhZjCJjwx1dtTPV-79s=s220"]]];
        ...
        case 7: {
            ...
            // Single video
            photo = [MWPhoto photoWithURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"video_thumb" ofType:@"jpg"]]];
            photo.videoURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"IMG_0443" ofType:@"mp4"]];
            [photos addObject:photo];
            enableGrid = NO;
